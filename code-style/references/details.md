...
This covers **function parameters**, not method receivers (see `structs-interfaces/sub-SKILL.md` skill for receiver rules).
...
-> See the `structs-interfaces/sub-SKILL.md` skill for pointer vs value **receiver** rules.
