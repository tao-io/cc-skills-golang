...
> **Community default.** A company skill that explicitly supersedes `code-style/sub-SKILL.md` skill takes precedence.

# Go Code Style

Style rules that require human judgment — linters handle formatting, this skill handles clarity. For naming see `naming/sub-SKILL.md` skill; for design patterns see `design-patterns/sub-SKILL.md` skill; for struct/interface design see `structs-interfaces/sub-SKILL.md` skill.
...
- Functions SHOULD have **≤4 parameters**. Beyond that, use an options struct (see `design-patterns/sub-SKILL.md` skill).
...
Many rules are enforced automatically: `gofmt`, `gofumpt`, `goimports`, `gocritic`, `revive`, `wsl_v5`. → See the `lint/sub-SKILL.md` skill.

## Cross-References

- → See the `naming/sub-SKILL.md` skill for identifier naming conventions
- → See the `structs-interfaces/sub-SKILL.md` skill for pointer vs value receivers, interface design
- → See the `design-patterns/sub-SKILL.md` skill for functional options, builders, constructors
- → See the `lint/sub-SKILL.md` skill for automated formatting enforcement
