...
> **Community default.** A company skill that explicitly supersedes `concurrency/sub-SKILL.md` skill takes precedence.
...
- -> See `performance/sub-SKILL.md` skill for false sharing, cache-line padding, `sync.Pool` hot-path patterns
- -> See `context/sub-SKILL.md` skill for cancellation propagation and timeout patterns
- -> See `safety/sub-SKILL.md` skill for concurrent map access and race condition prevention
- -> See `troubleshooting/sub-SKILL.md` skill for debugging goroutine leaks and deadlocks
- -> See `design-patterns/sub-SKILL.md` skill for graceful shutdown patterns
