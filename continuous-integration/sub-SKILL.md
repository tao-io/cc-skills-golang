...
Create `.golangci.yml` at the root of the project. See the `lint/sub-SKILL.md` skill for the recommended configuration.
...
See `lint/sub-SKILL.md`, `security/sub-SKILL.md`, `testing/sub-SKILL.md`, `dependency-management/sub-SKILL.md`, `modernize/sub-SKILL.md` skills.
