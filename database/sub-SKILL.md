...
> **Community default.** A company skill that explicitly supersedes `database/sub-SKILL.md` skill takes precedence.
...
For more injection prevention patterns, see the `security/sub-SKILL.md` skill.
...
For context patterns in depth, see the `context/sub-SKILL.md` skill.
...
- → See `security/sub-SKILL.md` skill for SQL injection prevention patterns
- → See `context/sub-SKILL.md` skill for context propagation to database operations
- → See `error-handling/sub-SKILL.md` skill for database error wrapping patterns
- → See `testing/sub-SKILL.md` skill for database integration test patterns
