...
> **For the full samber/do API, patterns, and advanced features, see the `samber-do/sub-SKILL.md` skill.**
...
→ See `samber-do/sub-SKILL.md` for full application setup, package organization, lifecycle management, debugging, testing with clone + override, and complete API reference.
