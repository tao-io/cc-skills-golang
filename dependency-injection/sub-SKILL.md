...
> **Community default.** A company skill that explicitly supersedes `dependency-injection/sub-SKILL.md` skill takes precedence.
...
For interface-based design foundations (accept interfaces, return structs), see the `structs-interfaces/sub-SKILL.md` skill.
...
- → See `samber-do/sub-SKILL.md` skill for detailed samber/do usage patterns
- → See `structs-interfaces/sub-SKILL.md` skill for interface design and composition
- → See `testing/sub-SKILL.md` skill for testing with dependency injection
- → See `project-layout/sub-SKILL.md` skill for DI initialization placement
