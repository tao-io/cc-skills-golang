...
> **Community default.** A company skill that explicitly supersedes `documentation/sub-SKILL.md` skill takes precedence.
...
See `naming/sub-SKILL.md` skill for naming conventions in doc comments. See `testing/sub-SKILL.md` skill for Example test functions. See `project-layout/sub-SKILL.md` skill for where documentation files belong.
