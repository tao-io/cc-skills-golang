...
For lifecycle, lazy loading, and a full matrix see `dependency-injection/sub-SKILL.md`.
...
- → See `uber-dig/sub-SKILL.md` skill for runtime reflection-based DI without lifecycle
- → See `uber-fx/sub-SKILL.md` skill for runtime DI with lifecycle hooks, modules, and signal-aware Run()
- → See `samber-do/sub-SKILL.md` skill for generics-based DI without reflection
