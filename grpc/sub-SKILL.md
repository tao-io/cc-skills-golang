...
- → See `context/sub-SKILL.md` skill for deadline and cancellation patterns
- → See `error-handling/sub-SKILL.md` skill for gRPC error to Go error mapping
- → See `observability/sub-SKILL.md` skill for gRPC interceptors (logging, tracing, metrics)
- → See `testing/sub-SKILL.md` skill for gRPC testing with bufconn
