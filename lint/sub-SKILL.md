...
For CI pipeline setup (GitHub Actions with `golangci-lint-action`), see the `continuous-integration/sub-SKILL.md` skill.
...
- → See `continuous-integration/sub-SKILL.md` skill for CI pipeline with golangci-lint-action
- → See `code-style/sub-SKILL.md` skill for style rules that linters enforce
- → See `security/sub-SKILL.md` skill for SAST tools beyond linting (gosec, govulncheck)
