...
Upgrade to golangci-lint v2. **Migration**: Run `golangci-lint migrate` to convert v1 config to v2. See the `lint/sub-SKILL.md` skill for the recommended configuration.
...
See the `continuous-integration/sub-SKILL.md` skill for ready-to-use GitHub Actions assets for both Claude Code and GitHub Copilot.
