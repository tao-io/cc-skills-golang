...
> **Community default.** A company skill that explicitly supersedes `naming/sub-SKILL.md` skill takes precedence.
...
Many naming convention issues are caught automatically by linters: `revive`, `predeclared`, `misspell`, `errname`. See `lint/sub-SKILL.md` skill for configuration and usage.

## Cross-References

- → See `code-style/sub-SKILL.md` skill for broader formatting and style decisions
- → See `structs-interfaces/sub-SKILL.md` skill for interface naming depth and receiver design
- → See `lint/sub-SKILL.md` skill for automated enforcement (revive, predeclared, misspell, errname)
