...
→ See `troubleshooting/sub-SKILL.md` skill (pprof.md) for on-demand debugging.
...
→ See `troubleshooting/sub-SKILL.md` pprof.md for the full pprof CLI reference (profile types, capturing, analyzing, commands).
