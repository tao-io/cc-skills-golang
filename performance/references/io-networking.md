...
→ See `concurrency/sub-SKILL.md` skill for detailed channel patterns and when to use worker pools instead.
...
→ See `database/sub-SKILL.md` skill for detailed batch patterns and connection pool configuration.
