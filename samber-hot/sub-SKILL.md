...
- → See `performance/sub-SKILL.md` skill for general caching strategy and when to use in-memory cache vs Redis vs CDN
- → See `observability/sub-SKILL.md` skill for Prometheus metrics integration and monitoring
- → See `database/sub-SKILL.md` skill for database query patterns that pair with cache loaders
