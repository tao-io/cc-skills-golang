...
- For reactive/streaming pipelines over infinite event streams, → see `samber-ro/sub-SKILL.md` skill + `samber/ro` package
...
- → See `samber-ro/sub-SKILL.md` skill for reactive/streaming pipelines over infinite event streams (`samber/ro` package)
- → See `samber-mo/sub-SKILL.md` skill for monadic types (Option, Result, Either) that compose with lo transforms
- → See `data-structures/sub-SKILL.md` skill for choosing the right underlying data structure
- → See `performance/sub-SKILL.md` skill for profiling methodology before switching to `lom`/`lop`
