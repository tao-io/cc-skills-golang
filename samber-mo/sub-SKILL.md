...
- -> See `samber-lo/sub-SKILL.md` skill for functional collection transforms (Map, Filter, Reduce on slices) that compose with mo types
- -> See `error-handling/sub-SKILL.md` skill for idiomatic Go error handling patterns
- -> See `safety/sub-SKILL.md` skill for nil-safety and defensive Go coding
- -> See `database/sub-SKILL.md` skill for database access patterns
- -> See `design-patterns/sub-SKILL.md` skill for functional options and other Go patterns
