...
- → See `observability/sub-SKILL.md` skill for slog fundamentals (levels, context, handler setup, migration)
- → See `error-handling/sub-SKILL.md` skill for the log-or-return rule
- → See `security/sub-SKILL.md` skill for PII handling in logs
- → See `samber-oops/sub-SKILL.md` skill for structured error context with `samber/oops`
