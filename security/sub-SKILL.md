...
Security-relevant linters: `bodyclose`, `sqlclosecheck`, `nilerr`, `errcheck`, `govet`, `staticcheck`. See the `lint/sub-SKILL.md` skill for configuration and usage.
...
See `database/sub-SKILL.md`, `safety/sub-SKILL.md`, `observability/sub-SKILL.md`, `continuous-integration/sub-SKILL.md` skills.
