...
→ See `spf13-viper/sub-SKILL.md` for the viper side of this integration.
...
- → See `cli/sub-SKILL.md` skill for general CLI architecture — project layout, exit codes, signal handling, I/O patterns
- → See `spf13-viper/sub-SKILL.md` skill for configuration layering alongside cobra (flag → env → file → default precedence)
