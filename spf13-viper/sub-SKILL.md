...
→ See `spf13-cobra/sub-SKILL.md` for the cobra side of this integration.
...
- → See `cli/sub-SKILL.md` skill for general CLI architecture — project layout, exit codes, signal handling, cobra+viper integration
- → See `spf13-cobra/sub-SKILL.md` skill for the cobra side of this integration (flag definition and binding)
- → See `testing/sub-SKILL.md` skill for general Go testing patterns
