...
Use `testifylint` to catch wrong argument order, assert/require misuse, and more. See `lint/sub-SKILL.md` skill.

## Cross-References

- → See `testing/sub-SKILL.md` skill for general test patterns, table-driven tests, and CI
- → See `lint/sub-SKILL.md` skill for testifylint configuration
