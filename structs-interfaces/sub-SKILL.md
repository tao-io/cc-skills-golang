...
> **Community default.** A company skill that explicitly supersedes `structs-interfaces/sub-SKILL.md` skill takes precedence.
...
→ See `naming/sub-SKILL.md` skill for interface naming conventions (method + "-er" suffix, canonical names)
...
- → See `naming/sub-SKILL.md` skill for interface naming conventions (Reader, Closer, Stringer)
- → See `design-patterns/sub-SKILL.md` skill for functional options, constructors, and builder patterns
- → See `dependency-injection/sub-SKILL.md` skill for DI patterns using interfaces
- → See `code-style/sub-SKILL.md` skill for value vs pointer function parameters (distinct from receivers)
