...
- → See `security/sub-SKILL.md` for securing the Swagger UI endpoint in production (disable or gate with auth middleware).
- → See `grpc/sub-SKILL.md` for gRPC — use grpc-gateway with its own OpenAPI generator instead of swag.
