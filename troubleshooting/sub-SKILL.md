...
- → See `performance/sub-SKILL.md` skill for optimization patterns after identifying bottlenecks
- → See `observability/sub-SKILL.md` skill for metrics, alerting, and Grafana dashboards for Go runtime monitoring
- → See `samber/cc-skills@promql-cli` skill for querying Prometheus metrics during production incident investigation
- → See `concurrency/sub-SKILL.md`, `safety/sub-SKILL.md`, `error-handling/sub-SKILL.md` skills
